const QUALTRICS_SCHEMA_URL = "/server/plugins/qualtrics/schemas/qualtricsSurveyConfig/qualtricsSurveyConfig.json";
...
function setQualtricsSurveyConfigSchema(monaco, json) {
    ...
    var schema = window.location.protocol + "//" + window.location.host + BASE_PATH + QUALTRICS_SCHEMA_URL;
...
function showQualtricsSurveyConfigBuilder(json, monacoEditor) {
    ...
    var schemaUrl = window.location.protocol + "//" + window.location.host + BASE_PATH + QUALTRICS_SCHEMA_URL;
