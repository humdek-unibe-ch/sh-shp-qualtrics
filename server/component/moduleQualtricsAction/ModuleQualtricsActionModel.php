 ...
 */
class ModuleQualtricsActionModel extends ModuleQualtricsModel
{
    ...
    public function get_notifications()
    {
        ...
        $fetch_notifivations = $this->db->query_db($sql, array(
            ":id_qualtricsActionScheduleTypes" => $this->db->get_lookup_id_by_value(actionScheduleJobs, actionScheduleJobs_notification)
        ));
